...
if(!Array.prototype.indexOf)
	Array.prototype.indexOf=function(c){
		...
		if(i>=a)return-1;
		for(i=i>=0?i:Math.max(a-Math.abs(i),0);
			i<a;i++)if(i in b&&b[i]===c)return i;
			return-1
	};
	if(!Function.prototype.bind)Function.prototype.bind=function(c){
		if(typeof this!=="function")
			throw new TypeError("Function.prototype.bind - what is trying to be bound is not callable");
		var b=Array.prototype.slice.call(arguments,1),a=this,i=function(){},j=function(){
			return a.apply(this instanceof i
				&&c?this:c,b.concat(Array.prototype.slice.call(arguments)))
		};
	...
	(function(){var c=function(){};
		...
		a=String.prototype.trim;c.isArray=function(a){
		...
		c.trim=a&& !a.call("\ufeff\u00a0")?function(i){
			return i==null?"":a.call(i)}:function(a){
				...
				c.makeColor=function(a,b){
					if(!a)
						return "";
					var d=c.hexToRgb(a);
					return c.isNumber(b)&&jbeeb.Browser.modern?(b>1&&(b/=100),
						"rgba("+d.join(",")+
							(","+b)+")"):jbeeb.Browser.modern?
					"rgb("+d.join(",")+")":a
				};
				c.getXYWH=function(a){
					var b=0,c=0,e=0,g=0;
					if(a){
						for(var e=a.offsetWidth,
							g=a.offsetHeight,
							f=jbeeb.Browser.touch;
							a&& !isNaN(a.offsetLeft)&& 
							!isNaN(a.offsetTop);)f?
							(b+=(a.offsetLeft||0)-(a.scrollLeft||0),c+=(a.offsetTop||0)-
								(a.scrollTop||0)):(b+=a.offsetLeft||0,c+=a.offsetTop||0),
						a=a.offsetParent;
						f&&(a=window.scrollY!=null?window.scrollY:window.pageYOffset,
							b+=window.scrollX!=null?window.scrollX:window.pageXOffset,c+=a)
					}
					...
					c.contains=function(a,b){
						...
						c.unbindEvent=function(a,b,c){
							a.addEventListener?a.removeEventListener(b,c,false):a.attachEvent&&
					...
					(function(){
						...
						function d(){
							if(!g){
								...
								document.addEventListener&& 
									!c&&document.addEventListener("DOMContentLoaded",i,false);
								...
								(function(){
									if(!f)
										if(document.readyState!="loaded"&&
											...
											if(d===void 0){
												for(var a=document.getElementsByTagName("link"),b=0;
													b<a.length;
													b++)a[b].getAttribute("rel")=="stylesheet"&&
													d++;
												a=document.getElementsByTagName("style");d+=a.length
											}
						...
						c=/opera/.test(e);
						b=/msie/.test(e)&& 
						!/opera/.test(e);/mozilla/.test(e)&&
						/(compatible|webkit)/.test(e);
						var g=false,f=false,h=[];
						d();
						jbeeb.ready=function(a){d();
					...
					(function(){
						...
						c.addListener=function(a,i){
							a!=null&&(c.aT||c.init(),
								c.removeListener(a),
								c.bk[c.bg.length]=i==null?true:i,
								c.bg.push(a))
						};
						c.init=function(){
							c.aT=true;
						...
						c.bV=function(){
							...
							b&&(c.ay++,c.aH+=i);
							c.bM=a;
							for(var d=c.bk,e=c.bg.slice(),
								g=e?e.length:0,f=0;f<g;f++){
								var h=e[f];
							h==null||b&&d[f]||
							(h.tick?h.tick.call(h,i,b):
								h instanceof Function&&h(i,b))
						}
					...
					(function(){
						var c,b,a={
							ie:null,ios:null,mac:null,webkit:null,oldWebkit:false,flash:false,touch:false
						};
						...
						a.webkit=b;
						a.chrome=/chrome/.test(c)||/chromium/.test(c);a.moz=/mozilla/.test(c);
						...
						if(a.chrome||a.safari)
							if(a.cssPrefix="webkit",a.chrome&&a.version<10)
								...
								a.cssPrefix="ms";
							a.flash=a.chrome||a.ios||
							a.android?false:
							typeof navigator.plugins!="undefined"&&
							typeof navigator.plugins["Shockwave Flash"]=="object"||window.ActiveXObject&&
							new ActiveXObject("ShockwaveFlash.ShockwaveFlash")!=false;
							c=false;
							b="Webkit Moz O ms Khtml".split(" ");var i="",
							...
							if(c===false)
								...
								(function(){
									...
									c.initialize=function(a){
										...
										a.hasEventListener=b.hasEventListener;a.dispatchEvent=b.dispatchEvent
									};
									b.bg=null;
									b.initialize=function(){};
									b.addEventListener=function(a,b,c){
										var d=this.bg;d?this.removeEventListener(a,b):d=this.bg={};
										var e=d[a];
										e||(e=d[a]=[]);
										e.push({
											fn:b,arg:c
